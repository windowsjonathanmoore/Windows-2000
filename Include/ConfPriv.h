...
EXTERN_C const IID IID_IMulticastControl;
    ...
    public:
        virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE get_LoopbackMode( 
            /* [retval][out] */ MULTICAST_LOOPBACK_MODE __RPC_FAR *pMode) = 0;
    ...
    typedef struct IMulticastControlVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *QueryInterface )( 
            IMulticastControl __RPC_FAR * This,
            /* [in] */ REFIID riid,
            /* [iid_is][out] */ void __RPC_FAR *__RPC_FAR *ppvObject);
        ...
        /* [helpstring][id][propget] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *get_LoopbackMode )( 
            IMulticastControl __RPC_FAR * This,
            /* [retval][out] */ MULTICAST_LOOPBACK_MODE __RPC_FAR *pMode);
        
        /* [helpstring][id][propput] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *put_LoopbackMode )( 
            IMulticastControl __RPC_FAR * This,
    ...
    interface IMulticastControl
    {
        CONST_VTBL struct IMulticastControlVtbl __RPC_FAR *lpVtbl;
    };
...
/* interface __MIDL_itf_confpriv_0164 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_confpriv_0164_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_confpriv_0164_v0_0_s_ifspec;
