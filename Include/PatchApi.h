...
#define PATCH_OPTION_USE_LZX_BEST       0x00000003  // auto choose best of LZX_A or LZX_B
#define PATCH_OPTION_USE_BEST           0x00000000  // same as USE_LZX_BEST

#define PATCH_OPTION_USE_LZX_LARGE      0x00000004  // better support for files >4MB, patches may not apply with mspatcha.dll < 1.96
