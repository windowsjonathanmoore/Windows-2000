...
//
// use old structure until printer component is updated.
//
#ifndef USE_SP_ALTPLATFORM_INFO_V1
#define USE_SP_ALTPLATFORM_INFO_V1 1
#endif
//
// remove to here once printer component is updated.
//
...
#define SPQ_FLAG_VALID             0x00000003  // mask of valid flags (can be passed as FlagMask)
...
#define PSETUPLOGERROR_ROUTINE PSETUPLOGERRORW_ROUTINE
#else
#define SetupLogError SetupLogErrorA
#define PSETUPLOGERROR_ROUTINE PSETUPLOGERRORA_ROUTINE
#endif
...
#define SPDRP_MAXIMUM_PROPERTY            (0x00000022)  // Upper bound on ordinals
