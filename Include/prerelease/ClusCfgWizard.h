...
#define IClusCfgWizard_AddComputer(This,bstrFQDNNameIn)	\
    (This)->lpVtbl -> AddComputer(This,bstrFQDNNameIn)

#define IClusCfgWizard_RemoveComputer(This,bstrFQDNNameIn)	\
    (This)->lpVtbl -> RemoveComputer(This,bstrFQDNNameIn)
