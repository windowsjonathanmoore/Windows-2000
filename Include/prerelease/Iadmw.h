...
EXTERN_C const IID IID_IMSAdminBase2W;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE Import( 
            ...
            /* [in] */ DWORD dwMDFlags,
            /* [defaultvalue][string][in][unique] */ LPCWSTR pszLogPath = 0) = 0;
    ...
    typedef struct IMSAdminBase2WVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *Import )( 
            ...
            /* [string][in][unique] */ LPCWSTR pszDestPath,
            /* [in] */ DWORD dwMDFlags,
            /* [defaultvalue][string][in][unique] */ LPCWSTR pszLogPath);
...
#define IMSAdminBase2W_Import(This,pszPasswd,pszFileName,pszSourcePath,pszDestPath,dwMDFlags,pszLogPath)	\
    (This)->lpVtbl -> Import(This,pszPasswd,pszFileName,pszSourcePath,pszDestPath,dwMDFlags,pszLogPath)
...
/* interface __MIDL_itf_iadmw_0258 */
/* [local] */ 

#endif


extern RPC_IF_HANDLE __MIDL_itf_iadmw_0258_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_iadmw_0258_v0_0_s_ifspec;
