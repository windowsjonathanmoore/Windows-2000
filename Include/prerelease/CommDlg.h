...
FARPROC WINAPI CommdlgPrivateIsolationAwareGetProcAddress_Comdlg32_dll(LPCSTR pszProcName);
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareGetOpenFileNameA(LPOPENFILENAMEA unnamed1)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommdlgPrivateIsolationAwareGetProcAddress_Comdlg32_dll("GetOpenFileNameA");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareGetOpenFileNameA\n");
            }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareGetOpenFileNameW(LPOPENFILENAMEW unnamed1)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommdlgPrivateIsolationAwareGetProcAddress_Comdlg32_dll("GetOpenFileNameW");
            if (s_pfn == NULL)
                __leave;
        }
        fResult = s_pfn(unnamed1);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareGetOpenFileNameW\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareGetSaveFileNameA(LPOPENFILENAMEA unnamed1)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommdlgPrivateIsolationAwareGetProcAddress_Comdlg32_dll("GetSaveFileNameA");
            if (s_pfn == NULL)
                __leave;
        }
        fResult = s_pfn(unnamed1);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareGetSaveFileNameA\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareGetSaveFileNameW(LPOPENFILENAMEW unnamed1)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommdlgPrivateIsolationAwareGetProcAddress_Comdlg32_dll("GetSaveFileNameW");
            if (s_pfn == NULL)
                __leave;
        }
        fResult = s_pfn(unnamed1);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareGetSaveFileNameW\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE short WINAPI IsolationAwareGetFileTitleA(LPCSTR unnamed1,LPSTR unnamed2,WORD unnamed3)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommdlgPrivateIsolationAwareGetProcAddress_Comdlg32_dll("GetFileTitleA");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareGetFileTitleA\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE short WINAPI IsolationAwareGetFileTitleW(LPCWSTR unnamed1,LPWSTR unnamed2,WORD unnamed3)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommdlgPrivateIsolationAwareGetProcAddress_Comdlg32_dll("GetFileTitleW");
            if (s_pfn == NULL)
                __leave;
        }
        nResult = s_pfn(unnamed1,unnamed2,unnamed3);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareGetFileTitleW\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareChooseColorA(LPCHOOSECOLORA unnamed1)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommdlgPrivateIsolationAwareGetProcAddress_Comdlg32_dll("ChooseColorA");
            if (s_pfn == NULL)
                __leave;
        }
        fResult = s_pfn(unnamed1);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareChooseColorA\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareChooseColorW(LPCHOOSECOLORW unnamed1)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommdlgPrivateIsolationAwareGetProcAddress_Comdlg32_dll("ChooseColorW");
            if (s_pfn == NULL)
                __leave;
        }
        fResult = s_pfn(unnamed1);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareChooseColorW\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE HWND WINAPI IsolationAwareFindTextA(LPFINDREPLACEA unnamed1)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommdlgPrivateIsolationAwareGetProcAddress_Comdlg32_dll("FindTextA");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareFindTextA\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE HWND WINAPI IsolationAwareFindTextW(LPFINDREPLACEW unnamed1)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommdlgPrivateIsolationAwareGetProcAddress_Comdlg32_dll("FindTextW");
            if (s_pfn == NULL)
                __leave;
        }
        windowResult = s_pfn(unnamed1);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareFindTextW\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE HWND WINAPI IsolationAwareReplaceTextA(LPFINDREPLACEA unnamed1)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommdlgPrivateIsolationAwareGetProcAddress_Comdlg32_dll("ReplaceTextA");
            if (s_pfn == NULL)
                __leave;
        }
        windowResult = s_pfn(unnamed1);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareReplaceTextA\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE HWND WINAPI IsolationAwareReplaceTextW(LPFINDREPLACEW unnamed1)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommdlgPrivateIsolationAwareGetProcAddress_Comdlg32_dll("ReplaceTextW");
            if (s_pfn == NULL)
                __leave;
        }
        windowResult = s_pfn(unnamed1);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareReplaceTextW\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareChooseFontA(LPCHOOSEFONTA unnamed1)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommdlgPrivateIsolationAwareGetProcAddress_Comdlg32_dll("ChooseFontA");
            if (s_pfn == NULL)
                __leave;
        }
        fResult = s_pfn(unnamed1);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareChooseFontA\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareChooseFontW(LPCHOOSEFONTW unnamed1)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommdlgPrivateIsolationAwareGetProcAddress_Comdlg32_dll("ChooseFontW");
            if (s_pfn == NULL)
                __leave;
        }
        fResult = s_pfn(unnamed1);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareChooseFontW\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwarePrintDlgA(LPPRINTDLGA unnamed1)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommdlgPrivateIsolationAwareGetProcAddress_Comdlg32_dll("PrintDlgA");
            if (s_pfn == NULL)
                __leave;
        }
        fResult = s_pfn(unnamed1);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwarePrintDlgA\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwarePrintDlgW(LPPRINTDLGW unnamed1)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommdlgPrivateIsolationAwareGetProcAddress_Comdlg32_dll("PrintDlgW");
            if (s_pfn == NULL)
                __leave;
        }
        fResult = s_pfn(unnamed1);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwarePrintDlgW\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwarePrintDlgExA(LPPRINTDLGEXA unnamed1)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommdlgPrivateIsolationAwareGetProcAddress_Comdlg32_dll("PrintDlgExA");
            if (s_pfn == NULL)
                goto ExitWin32ToHresult;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwarePrintDlgExA\n");
            }
        }
    }
    return result;
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwarePrintDlgExW(LPPRINTDLGEXW unnamed1)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommdlgPrivateIsolationAwareGetProcAddress_Comdlg32_dll("PrintDlgExW");
            if (s_pfn == NULL)
                goto ExitWin32ToHresult;
        }
        result = s_pfn(unnamed1);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwarePrintDlgExW\n");
            }
        }
    }
    return result;
...
ISOLATION_AWARE_INLINE DWORD WINAPI IsolationAwareCommDlgExtendedError(void)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommdlgPrivateIsolationAwareGetProcAddress_Comdlg32_dll("CommDlgExtendedError");
            if (s_pfn == NULL)
                __leave;
        }
        nResult = s_pfn();
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareCommDlgExtendedError\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwarePageSetupDlgA(LPPAGESETUPDLGA unnamed1)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommdlgPrivateIsolationAwareGetProcAddress_Comdlg32_dll("PageSetupDlgA");
            if (s_pfn == NULL)
                __leave;
        }
        fResult = s_pfn(unnamed1);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwarePageSetupDlgA\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwarePageSetupDlgW(LPPAGESETUPDLGW unnamed1)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommdlgPrivateIsolationAwareGetProcAddress_Comdlg32_dll("PageSetupDlgW");
            if (s_pfn == NULL)
                __leave;
        }
        fResult = s_pfn(unnamed1);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwarePageSetupDlgW\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE FARPROC WINAPI CommdlgPrivateIsolationAwareGetProcAddress_Comdlg32_dll(LPCSTR pszProcName)
        ...
        if (!g_fIsolationAwarePrivateDownlevel && fActivateActCtxSuccess)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in CommdlgPrivateIsolationAwareGetProcAddress_Comdlg32_dll\n");
            }
            if (proc == NULL)
                SetLastError(dwLastError);
        }
