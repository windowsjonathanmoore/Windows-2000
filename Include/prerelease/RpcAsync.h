...
#define RPC_CLIENT_SECURITY_CONTEXT_ATTRIBUTES_VERSION      (1)
#define RPC_QUERY_SERVER_PRINCIPAL_NAME                     (2)
#define RPC_QUERY_CLIENT_PRINCIPAL_NAME                     (4)

typedef struct tagRPC_CLIENT_SECURITY_CONTEXT_ATTRIBUTES_V1_W
{
    ...
    BOOL NullSession;
} RPC_CLIENT_SECURITY_CONTEXT_ATTRIBUTES_V1_W;

typedef struct tagRPC_CLIENT_SECURITY_CONTEXT_ATTRIBUTES_V1_A
{
    unsigned int Version;
    unsigned long Flags;
    ...
    unsigned long AuthenticationService;
    BOOL NullSession;
} RPC_CLIENT_SECURITY_CONTEXT_ATTRIBUTES_V1_A;

RPCRTAPI
RPC_STATUS
RPC_ENTRY
RpcInqClientSecurityContextAttributesW (
    IN RPC_BINDING_HANDLE ClientBinding, OPTIONAL
    IN OUT void *RpcClientSecurityContextAttributes
    );

RPCRTAPI
RPC_STATUS
RPC_ENTRY
RpcInqClientSecurityContextAttributesA (
    IN RPC_BINDING_HANDLE ClientBinding, OPTIONAL
    IN OUT void *RpcClientSecurityContextAttributes
    );

#ifdef UNICODE
#  define RPC_CLIENT_SECURITY_CONTEXT_ATTRIBUTES_V1 RPC_CLIENT_SECURITY_CONTEXT_ATTRIBUTES_V1_W
#  define RpcInqClientSecurityContextAttributes RpcInqClientSecurityContextAttributesW
#else
#  define RPC_CLIENT_SECURITY_CONTEXT_ATTRIBUTES_V1 RPC_CLIENT_SECURITY_CONTEXT_ATTRIBUTES_V1_A
#  define RpcInqClientSecurityContextAttributes RpcInqClientSecurityContextAttributesA
#endif // !UNICODE

typedef RPC_CLIENT_SECURITY_CONTEXT_ATTRIBUTES_V1 RPC_CLIENT_SECURITY_CONTEXT_ATTRIBUTES;
