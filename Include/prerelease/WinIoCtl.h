...
typedef struct _STORAGE_HOTPLUG_INFO {
    ...
    BOOLEAN WriteCacheEnableOverride; // ie. internal 1394 drives, user request, etc.
...
#define GPT_BASIC_DATA_ATTRIBUTE_HIDDEN_IF_CLONE    (0x2000000000000000)
#define GPT_BASIC_DATA_ATTRIBUTE_READ_ONLY          (0x1000000000000000)
#define GPT_BASIC_DATA_ATTRIBUTE_READ_ONLY_IF_CLONE (0x0800000000000000)
