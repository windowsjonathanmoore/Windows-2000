...
//
#define ERROR_PKINIT_FAILURE             2500L
...
//
#define ERROR_SMARTCARD_SUBSYSTEM_FAILURE 2501L
...
// MessageText:
//
//  The patch package is not permitted by system policy.  It is not signed with an appropriate certificate.
//
...
// MessageText:
//
//  One or more customizations are not permitted by system policy.  They are not signed with an appropriate certificate.
//
...
// MessageText:
//
//  The cluster node was evicted from the cluster successfully. The node was not cleaned up because it does not support the evict cleanup functionality.
//
...
// MessageText:
//
//  Adding a new mandatory attribute to an existing class, deleting a mandatory attribute from an existing class, or adding an optional attribute to the special class Top that is not a backlink attribute (directly or through inheritance, for example, by addin
//  g or deleting an auxiliary class) is not allowed.
//
...
//
// MessageId: ERROR_IPSEC_IKE_QM_LIMIT_REAP
//
// MessageText:
//
//  SA reaped because QM limit was reached
//
#define ERROR_IPSEC_IKE_QM_LIMIT_REAP    13880L
...
//  The context has expired and can no longer be used.
//
#define SEC_I_CONTEXT_EXPIRED            _HRESULT_TYPEDEF_(0x00090344L)
...
// MessageText:
//
//  The request subject does not match the certificate being renewed.
//
...
// MessageText:
//
//  The specified partition set name is already in use on this computer
//
#define COMADMIN_E_CAT_DUPLICATE_PARTITION_SET_NAME _HRESULT_TYPEDEF_(0x80110459L)
...
// MessageText:
//
//  The specified partition set name is invalid. Check that the name contains at least one visible character
//
#define COMADMIN_E_CAT_INVALID_PARTITION_SET_NAME _HRESULT_TYPEDEF_(0x8011045AL)
