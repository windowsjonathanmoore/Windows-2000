...
// The event method return values (NO_CHANGE to BREAK)
// must be ordered from weakest vote to strongest vote.
// Higher numbers override lower when voting.
...
#define DEBUG_ENGOPT_ALL                         0x000007FF
...
#define DEBUG_EXTENSION_CONTINUE_SEARCH \
    HRESULT_FROM_NT(STATUS_VALIDATE_CONTINUE)
