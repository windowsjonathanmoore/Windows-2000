...
typedef enum {
    ...
    ASSOCSTR_VALUE,             //  querys directly for value named by pszExtra
    ASSOCSTR_UIVALUE,           //  querys directly for value named by pszExtra, and loads it using MUI semantics
...
typedef enum {
    ...
    ASSOCKEY_SUBKEY,              //  querys directly for key named by pszExtra
...
typedef enum {
    ...
    ASSOCDATA_VALUE,              //  querys directly for value named by pszExtra
    ASSOCDATA_MAX
} ASSOCDATA;
