...
#define DISPID_SAX_ERRORHANDLER_WARNING (DISPID_SAX_ERRORHANDLER + 3)
...
#define DISPID_MX_READER_CONTROL_ASYNC (DISPID_MX_READER_CONTROL + 1)
#define DISPID_MX_READER_CONTROL_STATE (DISPID_MX_READER_CONTROL + 2)
#define DISPID_MX_READER_CONTROL_ABORT (DISPID_MX_READER_CONTROL + 3)
#define DISPID_MX_READER_CONTROL_RESET (DISPID_MX_READER_CONTROL + 4)
#define DISPID_MX_READER_CONTROL_RESUME (DISPID_MX_READER_CONTROL + 5)
#define DISPID_MX_READER_CONTROL_SUSPEND (DISPID_MX_READER_CONTROL + 6)
#define DISPID_MX_READER_CONTROL__TOP (DISPID_MX_READER_CONTROL + 7)
