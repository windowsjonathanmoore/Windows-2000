...
/*                                                                              
    Export Flags.                                                               
        ...
        MD_EXPORT_APPEND_FILE - If set, export will append file of same         
            name if it exists.  If not set, it will overwrite to the file.      
*/                                                                              
                                                                                
#define MD_EXPORT_INHERITED             0x00000001                              
#define MD_EXPORT_NODE_ONLY             0x00000002                              
#define MD_EXPORT_APPEND_FILE           0x00000004                              
