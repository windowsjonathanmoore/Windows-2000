...
#if (_WIN32_IE >= 0x0400) || ISOLATION_AWARE_ENABLED
...
FARPROC WINAPI PrshtPrivateIsolationAwareGetProcAddress_Comctl32_dll(LPCSTR pszProcName);
...
ISOLATION_AWARE_INLINE HPROPSHEETPAGE WINAPI IsolationAwareCreatePropertySheetPageA(LPCPROPSHEETPAGEA constPropSheetPagePointer)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)PrshtPrivateIsolationAwareGetProcAddress_Comctl32_dll("CreatePropertySheetPageA");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        {
            latestPropSheetPagePointer->dwFlags |= PSP_USEFUSIONCONTEXT;
            latestPropSheetPagePointer->hActCtx = g_hWinbasePrivateIsolationAwareMyActCtx;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareCreatePropertySheetPageA\n");
            }
...
ISOLATION_AWARE_INLINE HPROPSHEETPAGE WINAPI IsolationAwareCreatePropertySheetPageW(LPCPROPSHEETPAGEW constPropSheetPagePointer)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)PrshtPrivateIsolationAwareGetProcAddress_Comctl32_dll("CreatePropertySheetPageW");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareCreatePropertySheetPageW\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareDestroyPropertySheetPage(HPROPSHEETPAGE unnamed1)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)PrshtPrivateIsolationAwareGetProcAddress_Comctl32_dll("DestroyPropertySheetPage");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareDestroyPropertySheetPage\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE INT_PTR WINAPI IsolationAwarePropertySheetA(LPCPROPSHEETHEADERA unnamed1)
{
    ...
    static PFN s_pfn;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = g_fIsolationAwarePrivateDownlevel || IsolationAwareActivateActCtx(NULL, &ulpCookie);
    if (!fActivateActCtxSuccess)
        return nResult;
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)PrshtPrivateIsolationAwareGetProcAddress_Comctl32_dll("PropertySheetA");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwarePropertySheetA\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE INT_PTR WINAPI IsolationAwarePropertySheetW(LPCPROPSHEETHEADERW unnamed1)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)PrshtPrivateIsolationAwareGetProcAddress_Comctl32_dll("PropertySheetW");
            if (s_pfn == NULL)
                __leave;
        }
        nResult = s_pfn(unnamed1);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwarePropertySheetW\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE FARPROC WINAPI PrshtPrivateIsolationAwareGetProcAddress_Comctl32_dll(LPCSTR pszProcName)
        ...
        if (!g_fIsolationAwarePrivateDownlevel && fActivateActCtxSuccess)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in PrshtPrivateIsolationAwareGetProcAddress_Comctl32_dll\n");
            }
            if (proc == NULL)
                SetLastError(dwLastError);
        }
