...
DEFINE_GUID(IID_IMSMQMessage3,0xeba96b1a,0x2168,0x11d3,0x89,0x8c,0x00,0xe0,0x2c,0x07,0x4f,0x6b);
    ...
    typedef struct IMSMQMessage3Vtbl
    {
        ...
        /* [id][propget][helpstringcontext] */ HRESULT ( STDMETHODCALLTYPE *get_AdminDestination )( 
            IMSMQMessage3 * This,
            /* [retval][out] */ IDispatch **ppdestAdmin);
        
        /* [id][propputref][helpstringcontext] */ HRESULT ( STDMETHODCALLTYPE *putref_AdminDestination )( 
            IMSMQMessage3 * This,
            /* [in] */ IDispatch *pdestAdmin);
