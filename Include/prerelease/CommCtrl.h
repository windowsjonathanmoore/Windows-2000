...
int WINAPI DrawShadowText(HDC hdc, LPCTSTR pszText, UINT cch, RECT* prc, DWORD dwFlags, COLORREF crText, COLORREF crShadow,
...
FARPROC WINAPI CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll(LPCSTR pszProcName);
...
int WINAPI IsolationAwareDrawShadowText(HDC hdc,LPCTSTR pszText,UINT cch,RECT*prc,DWORD dwFlags,COLORREF crText,COLORREF crShadow,int ixOffset,int iyOffset);
...
ISOLATION_AWARE_INLINE void WINAPI IsolationAwareInitCommonControls(void)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("InitCommonControls");
            if (s_pfn == NULL)
                __leave;
        }
        s_pfn();
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareInitCommonControls\n");
            }
        }
    }
    return;
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareInitCommonControlsEx(LPINITCOMMONCONTROLSEX unnamed1)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("InitCommonControlsEx");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareInitCommonControlsEx\n");
            }
...
ISOLATION_AWARE_INLINE HIMAGELIST WINAPI IsolationAwareImageList_Create(int cx,int cy,UINT flags,int cInitial,int cGrow)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_Create");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_Create\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareImageList_Destroy(HIMAGELIST himl)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_Destroy");
            if (s_pfn == NULL)
                __leave;
        }
        fResult = s_pfn(himl);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_Destroy\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE int WINAPI IsolationAwareImageList_GetImageCount(HIMAGELIST himl)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_GetImageCount");
            if (s_pfn == NULL)
                __leave;
        }
        nResult = s_pfn(himl);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_GetImageCount\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareImageList_SetImageCount(HIMAGELIST himl,UINT uNewCount)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_SetImageCount");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_SetImageCount\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE int WINAPI IsolationAwareImageList_Add(HIMAGELIST himl,HBITMAP hbmImage,HBITMAP hbmMask)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_Add");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_Add\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE int WINAPI IsolationAwareImageList_ReplaceIcon(HIMAGELIST himl,int i,HICON hicon)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_ReplaceIcon");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_ReplaceIcon\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE COLORREF WINAPI IsolationAwareImageList_SetBkColor(HIMAGELIST himl,COLORREF clrBk)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_SetBkColor");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_SetBkColor\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE COLORREF WINAPI IsolationAwareImageList_GetBkColor(HIMAGELIST himl)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_GetBkColor");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_GetBkColor\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareImageList_SetOverlayImage(HIMAGELIST himl,int iImage,int iOverlay)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_SetOverlayImage");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_SetOverlayImage\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareImageList_Draw(HIMAGELIST himl,int i,HDC hdcDst,int x,int y,UINT fStyle)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_Draw");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_Draw\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareImageList_Replace(HIMAGELIST himl,int i,HBITMAP hbmImage,HBITMAP hbmMask)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_Replace");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_Replace\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE int WINAPI IsolationAwareImageList_AddMasked(HIMAGELIST himl,HBITMAP hbmImage,COLORREF crMask)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_AddMasked");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_AddMasked\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareImageList_DrawEx(HIMAGELIST himl,int i,HDC hdcDst,int x,int y,int dx,int dy,COLORREF rgbBk,COLORREF rgbFg,UINT fStyle)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_DrawEx");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_DrawEx\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareImageList_DrawIndirect(IMAGELISTDRAWPARAMS*pimldp)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_DrawIndirect");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_DrawIndirect\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareImageList_Remove(HIMAGELIST himl,int i)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_Remove");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_Remove\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE HICON WINAPI IsolationAwareImageList_GetIcon(HIMAGELIST himl,int i,UINT flags)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_GetIcon");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_GetIcon\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE HIMAGELIST WINAPI IsolationAwareImageList_LoadImageA(HINSTANCE hi,LPCSTR lpbmp,int cx,int cGrow,COLORREF crMask,UINT uType,UINT uFlags)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_LoadImageA");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_LoadImageA\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE HIMAGELIST WINAPI IsolationAwareImageList_LoadImageW(HINSTANCE hi,LPCWSTR lpbmp,int cx,int cGrow,COLORREF crMask,UINT uType,UINT uFlags)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_LoadImageW");
            if (s_pfn == NULL)
                __leave;
        }
        imagelistResult = s_pfn(hi,lpbmp,cx,cGrow,crMask,uType,uFlags);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_LoadImageW\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareImageList_Copy(HIMAGELIST himlDst,int iDst,HIMAGELIST himlSrc,int iSrc,UINT uFlags)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_Copy");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_Copy\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareImageList_BeginDrag(HIMAGELIST himlTrack,int iTrack,int dxHotspot,int dyHotspot)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_BeginDrag");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_BeginDrag\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE void WINAPI IsolationAwareImageList_EndDrag(void)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_EndDrag");
            if (s_pfn == NULL)
                __leave;
        }
        s_pfn();
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_EndDrag\n");
            }
        }
    }
    return;
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareImageList_DragEnter(HWND hwndLock,int x,int y)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_DragEnter");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_DragEnter\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareImageList_DragLeave(HWND hwndLock)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_DragLeave");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_DragLeave\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareImageList_DragMove(int x,int y)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_DragMove");
            if (s_pfn == NULL)
                __leave;
        }
        fResult = s_pfn(x,y);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_DragMove\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareImageList_SetDragCursorImage(HIMAGELIST himlDrag,int iDrag,int dxHotspot,int dyHotspot)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_SetDragCursorImage");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_SetDragCursorImage\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareImageList_DragShowNolock(BOOL fShow)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_DragShowNolock");
            if (s_pfn == NULL)
                __leave;
        }
        fResult = s_pfn(fShow);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_DragShowNolock\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE HIMAGELIST WINAPI IsolationAwareImageList_GetDragImage(POINT*ppt,POINT*pptHotspot)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_GetDragImage");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_GetDragImage\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE HIMAGELIST WINAPI IsolationAwareImageList_Read(LPSTREAM pstm)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_Read");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_Read\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareImageList_Write(HIMAGELIST himl,LPSTREAM pstm)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_Write");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_Write\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareImageList_GetIconSize(HIMAGELIST himl,int*cx,int*cy)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_GetIconSize");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_GetIconSize\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareImageList_SetIconSize(HIMAGELIST himl,int cx,int cy)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_SetIconSize");
            if (s_pfn == NULL)
                __leave;
        }
        fResult = s_pfn(himl,cx,cy);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_SetIconSize\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareImageList_GetImageInfo(HIMAGELIST himl,int i,IMAGEINFO*pImageInfo)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_GetImageInfo");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_GetImageInfo\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE HIMAGELIST WINAPI IsolationAwareImageList_Merge(HIMAGELIST himl1,int i1,HIMAGELIST himl2,int i2,int dx,int dy)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_Merge");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_Merge\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE HIMAGELIST WINAPI IsolationAwareImageList_Duplicate(HIMAGELIST himl)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ImageList_Duplicate");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareImageList_Duplicate\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE HWND WINAPI IsolationAwareCreateToolbarEx(HWND hwnd,DWORD ws,UINT wID,int nBitmaps,HINSTANCE hBMInst,UINT_PTR wBMID,LPCTBBUTTON lpButtons,int iNumButtons,int dxButton,int dyButton,int dxBitmap,int dyBitmap,UINT uStructSize)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("CreateToolbarEx");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareCreateToolbarEx\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE HBITMAP WINAPI IsolationAwareCreateMappedBitmap(HINSTANCE hInstance,INT_PTR idBitmap,UINT wFlags,LPCOLORMAP lpColorMap,int iNumMaps)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("CreateMappedBitmap");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareCreateMappedBitmap\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE void WINAPI IsolationAwareDrawStatusTextA(HDC hDC,LPRECT lprc,LPCSTR pszText,UINT uFlags)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("DrawStatusTextA");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareDrawStatusTextA\n");
            }
        }
    }
    return;
...
ISOLATION_AWARE_INLINE void WINAPI IsolationAwareDrawStatusTextW(HDC hDC,LPRECT lprc,LPCWSTR pszText,UINT uFlags)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("DrawStatusTextW");
            if (s_pfn == NULL)
                __leave;
        }
        s_pfn(hDC,lprc,pszText,uFlags);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareDrawStatusTextW\n");
            }
        }
    }
    return;
...
ISOLATION_AWARE_INLINE HWND WINAPI IsolationAwareCreateStatusWindowA(long style,LPCSTR lpszText,HWND hwndParent,UINT wID)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("CreateStatusWindowA");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareCreateStatusWindowA\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE HWND WINAPI IsolationAwareCreateStatusWindowW(long style,LPCWSTR lpszText,HWND hwndParent,UINT wID)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("CreateStatusWindowW");
            if (s_pfn == NULL)
                __leave;
        }
        windowResult = s_pfn(style,lpszText,hwndParent,wID);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareCreateStatusWindowW\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE void WINAPI IsolationAwareMenuHelp(UINT uMsg,WPARAM wParam,LPARAM lParam,HMENU hMainMenu,HINSTANCE hInst,HWND hwndStatus,UINT*lpwIDs)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("MenuHelp");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareMenuHelp\n");
            }
        }
    }
    return;
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareShowHideMenuCtl(HWND hWnd,UINT_PTR uFlags,LPINT lpInfo)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("ShowHideMenuCtl");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareShowHideMenuCtl\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE void WINAPI IsolationAwareGetEffectiveClientRect(HWND hWnd,LPRECT lprc,LPINT lpInfo)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("GetEffectiveClientRect");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareGetEffectiveClientRect\n");
            }
        }
    }
    return;
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareMakeDragList(HWND hLB)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("MakeDragList");
            if (s_pfn == NULL)
                __leave;
        }
        fResult = s_pfn(hLB);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareMakeDragList\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE void WINAPI IsolationAwareDrawInsert(HWND handParent,HWND hLB,int nItem)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("DrawInsert");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareDrawInsert\n");
            }
        }
    }
    return;
...
ISOLATION_AWARE_INLINE int WINAPI IsolationAwareLBItemFromPt(HWND hLB,POINT pt,BOOL bAutoScroll)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("LBItemFromPt");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareLBItemFromPt\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE HWND WINAPI IsolationAwareCreateUpDownControl(DWORD dwStyle,int x,int y,int cx,int cy,HWND hParent,int nID,HINSTANCE hInst,HWND hBuddy,int nUpper,int nLower,int nPos)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("CreateUpDownControl");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareCreateUpDownControl\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE void WINAPI IsolationAwareInitMUILanguage(LANGID uiLang)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("InitMUILanguage");
            if (s_pfn == NULL)
                __leave;
        }
        s_pfn(uiLang);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareInitMUILanguage\n");
            }
        }
    }
    return;
...
ISOLATION_AWARE_INLINE LANGID WINAPI IsolationAwareGetMUILanguage(void)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("GetMUILanguage");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareGetMUILanguage\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAware_TrackMouseEvent(LPTRACKMOUSEEVENT lpEventTrack)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("_TrackMouseEvent");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAware_TrackMouseEvent\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareFlatSB_EnableScrollBar(HWND unnamed1,int unnamed2,UINT unnamed3)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("FlatSB_EnableScrollBar");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareFlatSB_EnableScrollBar\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareFlatSB_ShowScrollBar(HWND unnamed1,int code,BOOL unnamed2)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("FlatSB_ShowScrollBar");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareFlatSB_ShowScrollBar\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareFlatSB_GetScrollRange(HWND unnamed1,int code,LPINT unnamed2,LPINT unnamed3)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("FlatSB_GetScrollRange");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareFlatSB_GetScrollRange\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareFlatSB_GetScrollInfo(HWND unnamed1,int code,LPSCROLLINFO unnamed2)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("FlatSB_GetScrollInfo");
            if (s_pfn == NULL)
                __leave;
        }
        fResult = s_pfn(unnamed1,code,unnamed2);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareFlatSB_GetScrollInfo\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE int WINAPI IsolationAwareFlatSB_GetScrollPos(HWND unnamed1,int code)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("FlatSB_GetScrollPos");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareFlatSB_GetScrollPos\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareFlatSB_GetScrollProp(HWND unnamed1,int propIndex,LPINT unnamed2)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("FlatSB_GetScrollProp");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareFlatSB_GetScrollProp\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareFlatSB_GetScrollPropPtr(HWND unnamed1,int propIndex,PINT_PTR unnamed2)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("FlatSB_GetScrollPropPtr");
            if (s_pfn == NULL)
                __leave;
        }
        fResult = s_pfn(unnamed1,propIndex,unnamed2);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareFlatSB_GetScrollPropPtr\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE int WINAPI IsolationAwareFlatSB_SetScrollPos(HWND unnamed1,int code,int pos,BOOL fRedraw)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("FlatSB_SetScrollPos");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareFlatSB_SetScrollPos\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE int WINAPI IsolationAwareFlatSB_SetScrollInfo(HWND unnamed1,int code,LPSCROLLINFO unnamed2,BOOL fRedraw)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("FlatSB_SetScrollInfo");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareFlatSB_SetScrollInfo\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE int WINAPI IsolationAwareFlatSB_SetScrollRange(HWND unnamed1,int code,int min,int max,BOOL fRedraw)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("FlatSB_SetScrollRange");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareFlatSB_SetScrollRange\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareFlatSB_SetScrollProp(HWND unnamed1,UINT index,INT_PTR newValue,BOOL unnamed2)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("FlatSB_SetScrollProp");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareFlatSB_SetScrollProp\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareInitializeFlatSB(HWND unnamed1)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("InitializeFlatSB");
            if (s_pfn == NULL)
                __leave;
        }
        fResult = s_pfn(unnamed1);
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareInitializeFlatSB\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareUninitializeFlatSB(HWND unnamed1)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("UninitializeFlatSB");
            if (s_pfn == NULL)
                goto ExitWin32ToHresult;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareUninitializeFlatSB\n");
            }
        }
    }
    return result;
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareSetWindowSubclass(HWND hWnd,SUBCLASSPROC pfnSubclass,UINT_PTR uIdSubclass,DWORD_PTR dwRefData)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("SetWindowSubclass");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareSetWindowSubclass\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareGetWindowSubclass(HWND hWnd,SUBCLASSPROC pfnSubclass,UINT_PTR uIdSubclass,DWORD_PTR*pdwRefData)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("GetWindowSubclass");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareGetWindowSubclass\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareRemoveWindowSubclass(HWND hWnd,SUBCLASSPROC pfnSubclass,UINT_PTR uIdSubclass)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("RemoveWindowSubclass");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareRemoveWindowSubclass\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE LRESULT WINAPI IsolationAwareDefSubclassProc(HWND hWnd,UINT uMsg,WPARAM wParam,LPARAM lParam)
{
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("DefSubclassProc");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareDefSubclassProc\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE int WINAPI IsolationAwareDrawShadowText(HDC hdc,LPCTSTR pszText,UINT cch,RECT*prc,DWORD dwFlags,COLORREF crText,COLORREF crShadow,int ixOffset,int iyOffset)
{
    int nResult = -1;
    typedef int (WINAPI* PFN)(HDC hdc,LPCTSTR pszText,UINT cch,RECT*prc,DWORD dwFlags,COLORREF crText,COLORREF crShadow,int ixOffset,int iyOffset);
    static PFN s_pfn;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = g_fIsolationAwarePrivateDownlevel || IsolationAwarePrivateActivateMyActCtx(&ulpCookie);
    if (!fActivateActCtxSuccess)
    ...
    __try
    {
        if (s_pfn == NULL)
        {
            s_pfn = (PFN)CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll("DrawShadowText");
            if (s_pfn == NULL)
                __leave;
        }
        ...
        if (!g_fIsolationAwarePrivateDownlevel)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in IsolationAwareDrawShadowText\n");
            }
            if (fPreserveLastError)
                SetLastError(dwLastError);
        }
...
ISOLATION_AWARE_INLINE FARPROC WINAPI CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll(LPCSTR pszProcName)
/* This function is shared by the other stubs in this header. */
{
    ...
    __try
    {
        if (s_module == NULL)
        {
            if (!g_fIsolationAwarePrivateDownlevel)
            {
                fActivateActCtxSuccess = IsolationAwarePrivateActivateMyActCtx(&ulpCookie);
                if (!fActivateActCtxSuccess)
                    __leave;
            }
    ...
    __finally
    {
        if (!g_fIsolationAwarePrivateDownlevel && fActivateActCtxSuccess)
        {
            ...
            if (!IsolationAwareDeactivateActCtx(0, ulpCookie))
            {
                ...
                if (dwLastError2 != ERROR_PROC_NOT_FOUND
                    ...
                    OutputDebugStringA("DeactivateActCtx failed in CommctrlPrivateIsolationAwareGetProcAddress_Comctl32_dll\n");
            }
            if (proc == NULL)
                SetLastError(dwLastError);
        }
