...
/* interface __MIDL_itf_msdasc_0345 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_msdasc_0345_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_msdasc_0345_v0_0_s_ifspec;
...
EXTERN_C const IID IID_IDataSourceLocator;
    ...
    public:
        virtual /* [helpstring][propget] */ HRESULT STDMETHODCALLTYPE get_hWnd( 
            /* [retval][out] */ COMPATIBLE_LONG __RPC_FAR *phwndParent) = 0;
    ...
    typedef struct IDataSourceLocatorVtbl
    {
        ...
        /* [helpstring][propget] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *get_hWnd )( 
            IDataSourceLocator __RPC_FAR * This,
            /* [retval][out] */ COMPATIBLE_LONG __RPC_FAR *phwndParent);
