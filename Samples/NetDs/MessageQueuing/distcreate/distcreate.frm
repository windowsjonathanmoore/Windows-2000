...
qinfo.Pathname = ".\QueueName1"
qinfo.Create
qinfo.Pathname = ".\QueueName2"
qinfo.Create
...
' The AdsPaths of the public queues:
strQ1 = "LDAP://CN=QueueName1,CN=msmq," + strComputerName
strQ2 = "LDAP://CN=QueueName2,CN=msmq," + strComputerName

' Adding the public queues to the distribution list (these changes will
