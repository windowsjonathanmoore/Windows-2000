...
/* (C) Copyright 1990 - 2001 Data Connection Ltd.                            */
/*                                                                           */
...
#endif
void            csv_init            (void);
int             issue_verb          (unsigned short type);
...
#endif
{
  ...
  /***************************************************************************/
  if (issue_verb(LUA_OPCODE_SLI_OPEN))
  {
    printf("OPEN failed\n");
    exit(1);
  }
...
void closedown (void)
{
  ...
  {                                /* another section of the code            */
    ...
    printf("Closedown\n");
    if (issue_verb(LUA_OPCODE_SLI_CLOSE))
    {
      exit(1);
    }
    exit(0);
...

{
  ...
  other_verb.common.lua_data_length      = (unsigned short)write_len;
