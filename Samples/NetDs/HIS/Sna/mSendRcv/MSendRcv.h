...
/* (C) COPYRIGHT DATA CONNECTION LIMITED 1994-2001 */
...
HWND hWndMain;
char title[40]={'\0'};
#define OUTPUTNUMBER sprintf(title,"thr sms smr rdn  %d  %d  %d  %d", \
                     ThreadCount,SimSendConvs,SimRcvConvs,RcvConvs);  \
...
void Build_MC_SEND_CONVERSATION(CONVCB * convptr);
