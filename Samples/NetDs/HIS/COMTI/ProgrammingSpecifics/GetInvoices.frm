...
Begin VB.Form frmGetInvoices 
   ...
   End
End
Attribute VB_Name = "frmGetInvoices"
...
'See the CedarBank tutorial website for returning recordsets into an RDS
'recordset on a web site
