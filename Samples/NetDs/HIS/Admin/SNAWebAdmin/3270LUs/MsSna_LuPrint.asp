...
<!-------------------------------------------------------------------------
   ...
   an ASP, using VBScript.  It displays 3270 Print LU information in a table
   for each Printer LU in the local domain.
...
---------------------------------------------------------------------------->
<head>
<title>SNA 3270 Print LU ASP Query Page!</title>
</head>
...
<%
	...
	if Err = 0 then
		...
		Set ServerClass = WmiNamespace.Get("MsSNA_LuPrint")
