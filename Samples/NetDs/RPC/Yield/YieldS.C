/****************************************************************************
    ...
    USAGE:  yields  -p protocol_sequence
                    -e endpoint
                    -m max calls
                    -n min calls
                    -f flag for RpcServerListen

    PURPOSE:    Server side of RPC distributed application yield
    ...
    COMMENTS:   This sample program generates a linked list to
                ...
                DOUBLE_LINK_TYPE in the file yield.IDL) requires the
...
void __cdecl main(int argc, char * argv[])
{
    ...
    unsigned char * pszEndpoint     = "\\pipe\\yield";
    ...
    status = RpcServerRegisterIf(yield_ServerIfHandle, // interface to register
                                 NULL,   // MgrTypeUuid
