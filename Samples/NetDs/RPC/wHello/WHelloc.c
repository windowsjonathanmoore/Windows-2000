...
LONG_PTR APIENTRY MainWndProc(HWND   hWnd,       // window handle
...
****************************************************************************/
LONG_PTR APIENTRY Protseq(HWND hDlg,       // window handle of the dialog box
                     UINT message,     // type of message
...
LONG_PTR APIENTRY Server(HWND hDlg,        // window handle of the dialog box
                     UINT message,     // type of message
                     WPARAM wParam,      // message-specific information
                     LPARAM lParam)
{
...
LONG_PTR APIENTRY About(HWND hDlg,         // window handle of the dialog box
                    UINT message,      // type of message
                    WPARAM wParam,       // message-specific information
                    LPARAM lParam)
{
...
LONG_PTR APIENTRY Endpoint(HWND hDlg,        // window handle of the dialog box
                       UINT message,     // type of message
                       WPARAM wParam,      // message-specific information
                       LPARAM lParam)
{
...
LONG_PTR APIENTRY Send(HWND hDlg,        // window handle of the dialog box
                   UINT message,     // type of message
                   WPARAM wParam,      // message-specific information
                   LPARAM lParam)
{
