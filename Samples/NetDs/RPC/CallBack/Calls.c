/****************************************************************************
    ...
    USAGE:      calls  -p protocol_sequence
                       -e endpoint
                       -m max calls
                       -n min calls
                       -f flag for RpcServerListen

    PURPOSE:    Server side of RPC distributed application call
...
void __cdecl main(int argc, char * argv[])
{
    ...
    status = RpcServerRegisterIf(callback_ServerIfHandle,  // interface to register
                                 NULL,   // MgrTypeUuid
