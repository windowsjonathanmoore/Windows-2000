...
BOOL CALLBACK PASCAL IntoneDlg(
    HWND hWndDlg,
    UINT Message,
    WPARAM wParam,
    LPARAM lParam
...
BOOL CALLBACK PASCAL PlayerDlg(
    HWND hWndDlg,
    UINT Message,
    WPARAM wParam,
    LPARAM lParam
...
//TODO -- shouldn't it be hWindow,hDC???
