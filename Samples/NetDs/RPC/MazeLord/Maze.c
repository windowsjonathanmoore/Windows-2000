    ...
    switch (Message) {
		...
		GetStringRes2(IDS_HSCO),  MB_ICONHAND | MB_APPLMODAL);
                ...
                case IDM_O_PLAYERSET:
                    bDemoEnable = FALSE;
                    nRc = DialogBox(hInst,"PLAY_CONF_DLG",hWnd,(DLGPROC)PlayerDlg);
                    bDemoEnable = TRUE;
                    break;

                case IDM_O_DRONES:
                    bDemoEnable = FALSE;
                    nRc = DialogBox(hInst,"DRONE_DLG", hWnd, (DLGPROC)DroneDlg);
                    if (GameStarted) {
                        ...
                        if ((iNumDrones)&&(iDroneSpeed != 0)) {
                            if (! (uiTimer = SetTimer((HWND)NULL,0,(UINT)ONE_SECOND/iDroneSpeed,MoveDrone))) {
                ...
                case IDM_ABOUT:
                    bDemoEnable = FALSE;
                    nRc = DialogBox(hInst,"MDLG_ABOUT", hWnd, (DLGPROC)AboutDlg);
                    bDemoEnable = TRUE;
                    break;
        ...
        case WM_CREATE:
            ...
            //
            SetTimer(hWnd,(UINT_PTR) NULL, (UINT) (30*1000),(TIMERPROC) NULL);
            //
    ...
    )
{
    ...
    wndclass.lpfnWndProc = (WNDPROC)MazeWndProc;
    ...
    //
    wndclass.lpfnWndProc = (WNDPROC)TopViewWndProc;
    ...
    //
    wndclass.lpfnWndProc = (WNDPROC)ScoreWndProc;
