...
CHAR  szBuf[120];
     ...
     sprintf(szBuf,"\nDomainName =  %ws\nUserName = %ws\n",DomainName, UserName);
     WriteFile(ErrLogFile, (LPSTR)szBuf, (int) strlen(szBuf), &dwBytesWritten, NULL);
...
WCHAR *Interface_Type[] =
   ...
   //dumping pRasConnection0
   WriteFile(cLogFile, (LPSTR)buf, (int) strlen(buf), &dwBytesWritten, NULL);
   sprintf(buf,"dumping pRasConnection0\n\n");
   WriteFile(cLogFile, (LPSTR)buf, (int) strlen(buf), &dwBytesWritten, NULL);
   sprintf(buf,"pRasConnection0->hConnection  0x%l64x\n",pRasConnection0->hConnection);
   WriteFile(cLogFile, (LPSTR)buf, (int) strlen(buf), &dwBytesWritten, NULL);
   sprintf(buf,"pRasConnection0->hInterface   0x%l64x\n",pRasConnection0->hInterface);
   WriteFile(cLogFile, (LPSTR)buf, (int) strlen(buf), &dwBytesWritten, NULL);
...
VOID File_Print_Connection1(RAS_CONNECTION_1 *pRasConnection1)
{
   ...
   WriteFile(cLogFile, (LPSTR)buf, (int) strlen(buf), &dwBytesWritten, NULL);
   sprintf(buf, "pRasConnection1->hInterface   0x%l64x\n",pRasConnection1->hInterface);
   WriteFile(cLogFile, (LPSTR)buf, (int) strlen(buf), &dwBytesWritten, NULL);
...
WCHAR *Hdw_Error[] =
   ...
   WriteFile(cLogFile, (LPSTR)buf, (int) strlen(buf), &dwBytesWritten, NULL);
   sprintf(buf,"pRasPort0->hPort  %l64d\n",pRasPort0->hPort);
   WriteFile(cLogFile, (LPSTR)buf, (int) strlen(buf), &dwBytesWritten, NULL);
   sprintf(buf,"pRasPort0->hConnection   0x%l64x\n",pRasPort0->hConnection);
   WriteFile(cLogFile, (LPSTR)buf, (int) strlen(buf), &dwBytesWritten, NULL);
...
WCHAR *Hdw_Error[] =
   ...
   sprintf(buf,"\n dumping pRasPort1\n");
   WriteFile(cLogFile, (LPSTR)buf, (int) strlen(buf), &dwBytesWritten, NULL);
   sprintf(buf,"pRasPort1->hPort  %l64d\n",pRasPort1->hPort);
   WriteFile(cLogFile, (LPSTR)buf, (int) strlen(buf), &dwBytesWritten, NULL);
   sprintf(buf,"pRasPort1->hConnection   0x%l64x\n",pRasPort1->hConnection);
   WriteFile(cLogFile, (LPSTR)buf, (int) strlen(buf), &dwBytesWritten, NULL);
...
lpszString = &Buf[0];
   ...
   else
   {
      ...
      sprintf(szBuf, "\n\nMprAdminPortClearStats Called From ProcPortClearStat, Now dumping structs\n");
      WriteFile(cLogFile, (LPSTR)szBuf, (int) strlen(szBuf), &dwBytesWritten, NULL);
...
lpszString = &Buf[0];
 ...
 sprintf(szBuf, "info: called MprAdminServerDisconnect(hRasServer=0x%l64x)\n", phRasServer);
 WriteFile(LogFile, (LPSTR)szBuf, (int) strlen(szBuf), &dwBytesWritten, NULL);
