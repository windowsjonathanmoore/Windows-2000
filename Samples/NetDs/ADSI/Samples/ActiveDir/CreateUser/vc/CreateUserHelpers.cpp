...
WCHAR * CrackADError(HRESULT hResult)
{
   ...
   switch( hResult )
   {
      ...
      // case  HRESULT_FROM_WIN32(E_ADS_LDAP_ALIAS_PROBLEM:
         // return L"HRESULT_FROM_WIN32(E_ADS_LDAP_ALIAS_PROBLEM";
         // break;
      ...
      // case  HRESULT_FROM_WIN32(E_ADS_LDAP_MORE_RESULTS_TO_RETURN:
         // return L"HRESULT_FROM_WIN32(E_ADS_LDAP_MORE_RESULTS_TO_RETURN";
         // break;
      ...
      // case  HRESULT_FROM_WIN32(E_ADS_LDAP_LAST:
         // return L"HRESULT_FROM_WIN32(E_ADS_LDAP_LAST";
         // break;
