...
'  File:       printqueue.bas
'
'  Contents:   Show how to enumerate and display print queue and print jobs
'
'----------------------------------------------------------------------------
...
'----------------------------------------------------
'--- Enumerating Printer in a computer -------------
'----------------------------------------------------
...
Function GetPrintStatus(status As Long) As String
...
Function GetJobStatus(status As Long) As String
