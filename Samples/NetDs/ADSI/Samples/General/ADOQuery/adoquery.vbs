...
'------------------------------------------------------------------------------
    ...
    ' for example: Com.CommandText = "select name from 'LDAP://ntdsdc1/dc=ntdev,dc=microsoft,dc=com' where objectClass='*'"
    ' Exchange Example:"select name from 'LDAP://exchsrv1/O=Microsoft' where objectClass='*'"
