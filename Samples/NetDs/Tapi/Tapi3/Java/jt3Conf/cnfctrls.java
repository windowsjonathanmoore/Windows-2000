...
public class cnfctrls
{
	...
	// Constructor
	//--------------------------------------------------------------------------
	public cnfctrls (Container parent)
	{
		m_Parent = parent;
	}
	...
	public boolean CreateControls()
	{
		...
		// dlayout3 manager.
		//----------------------------------------------------------------------
		m_Layout = new dlayout3(m_Parent, 334, 144);
		...
		m_Layout.setShape(btnCreate, 222, 125, 50, 14);

		btnClose = new Button ("Close");
		m_Parent.add(btnClose);
		m_Layout.setShape(btnClose, 277, 125, 50, 14);
		...
		*/
		...
		m_Layout.setShape(cmbStartMonth, 173, 58, 55, 65);
		...
		m_Layout.setShape(cmbStopMonth, 173, 98, 55, 65);
