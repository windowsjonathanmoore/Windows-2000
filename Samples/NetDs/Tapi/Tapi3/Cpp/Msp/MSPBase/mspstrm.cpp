...
HRESULT CMSPStream::ReleaseSink()
{
    ...
    if( m_pPTEventSink)
    {
        ...
        CPTEventSink *pSinkObject = dynamic_cast<CPTEventSink *>(m_pPTEventSink);
        ...
        else
        {
            ...
            //
            // this should not happen -- our pointer should always point to a 
            // CPTEventSink object
            //

            LOG((MSP_ERROR, "CMSPStream::ReleaseSink - the sink is not CPTEventSink"));
