...
//
INT_PTR CreateWizard(HWND hwndOwner, HINSTANCE hInst)
{
    PROPSHEETPAGE psp[NUM_PAGES];
    PROPSHEETHEADER psh;

    FillInPropertyPage( &psp[0], IDD_WELCOME, TEXT("Welcome"), (DLGPROC)Welcome);
    //FillInPropertyPage( &psp[1], IDD_LICENSE, TEXT("Software License Agreement"), License);
    FillInPropertyPage( &psp[1], IDD_INFO, TEXT("Your Information"), (DLGPROC)YourInfo);
    FillInPropertyPage( &psp[2], IDD_INSTALL_TYPE, TEXT("Installation Type"), (DLGPROC)Install_Type);
    FillInPropertyPage( &psp[3], IDD_INSTALL_DESTINATION, TEXT("Installation Location"), (DLGPROC)Install_Destination);
    FillInPropertyPage( &psp[4], IDD_CUSTOM_OPTIONS, TEXT("Custom Installation Options"), (DLGPROC)Custom_Options);
    FillInPropertyPage( &psp[5], IDD_INSTALL, TEXT("Finish Installation"), (DLGPROC)Install);
