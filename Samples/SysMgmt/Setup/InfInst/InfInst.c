...
INSTALLINFORM setupInfo;      // a structure containing the review information
...
void RuntimeRegistration(INSTALLINFORM *si)
{
    //
   ...
   )
{
    ...
    if (ERROR_SUCCESS != 
        RegSetValueEx(
            ...
            (BYTE*)pszData,             // address of value data 
            (int)strlen(pszData) ))      // size of value data 
    {
