...
#define DEFINE_LOCALIZED_STRINGS                                            \
    ...
    DEFMAC (g_MyProductId,      "Windows 95 Screen Savers")                 \
                                                                            \
	DEFMAC (COMPANY_NAME,		"Microsoft")								\
																			\
	DEFMAC (SUPPORT_NUMBER,		"555-555-5555")								\
																			\
	DEFMAC (SUPPORT_URL,		"http://support.microsoft.com/support")		\
																			\
	DEFMAC (INSTRUCTIONS,		"The Screen Saver Migration DLL has"		\
								"failed!")									\
																			\
