...
ALL : "$(OUTDIR)\ps_win32\FullSvr.tlb"


CLEAN :
	-@erase ".\ps_win32\FullSvr.tlb"
...
MTL_SWITCHES=/tlb "$(OUTDIR)\FullSvr.tlb" /out "ps_win32" /Oicf /env win32 

".\ps_win32\FullSvr.tlb" : $(SOURCE) "$(INTDIR)"
	$(MTL) @<<
  $(MTL_SWITCHES) $(SOURCE)
<<
