...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /incremental:no /pdb:"$(OUTDIR)\HelpDll.pdb" /machine:I386 /out:"$(OUTDIR)\HelpDll.dll" /implib:"$(OUTDIR)\HelpDll.lib" 
LINK32_OBJS= \
	"$(INTDIR)\HelpDll.obj" \
	"$(INTDIR)\StdAfx.obj"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /incremental:yes /pdb:"$(OUTDIR)\HelpDll.pdb" /debug /machine:I386 /out:"$(OUTDIR)\HelpDll.dll" /implib:"$(OUTDIR)\HelpDll.lib" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\HelpDll.obj" \
	"$(INTDIR)\StdAfx.obj"
