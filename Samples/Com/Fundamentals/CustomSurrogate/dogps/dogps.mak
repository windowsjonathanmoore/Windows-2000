...
CPP_PROJ=/nologo /MT /W3 /GX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "DOGPS_EXPORTS" /D _WIN32_WINNT=0x0400 /D "REGISTER_PROXY_DLL" /Fp"$(INTDIR)\dogps.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib rpcndr.lib rpcns4.lib rpcrt4.lib /nologo /dll /incremental:no /pdb:"$(OUTDIR)\dogps.pdb" /machine:I386 /def:"..\dog\dog.def" /out:"$(OUTDIR)\dogps.dll" /implib:"$(OUTDIR)\dogps.lib" 
DEF_FILE= \
	"..\dog\dog.def"
LINK32_OBJS= \
	"$(INTDIR)\idog_p.obj" \
...
CPP_PROJ=/nologo /MTd /W3 /Gm /GX /ZI /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "DOGPS_EXPORTS" /D _WIN32_WINNT=0x0400 /D "REGISTER_PROXY_DLL" /Fp"$(INTDIR)\dogps.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ  /c 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib rpcndr.lib rpcns4.lib rpcrt4.lib /nologo /dll /incremental:yes /pdb:"$(OUTDIR)\dogps.pdb" /debug /machine:I386 /def:"..\dog\dog.def" /out:"$(OUTDIR)\dogps.dll" /implib:"$(OUTDIR)\dogps.lib" /pdbtype:sept 
DEF_FILE= \
	"..\dog\dog.def"
LINK32_OBJS= \
	"$(INTDIR)\idog_p.obj" \
