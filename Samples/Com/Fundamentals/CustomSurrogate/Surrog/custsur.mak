...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\custsur.pdb" /machine:I386 /out:"$(OUTDIR)\custsur.exe" 
LINK32_OBJS= \
	"$(INTDIR)\cfwrap.obj" \
	"$(INTDIR)\csur.obj" \
	"$(INTDIR)\custsur.obj" \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\custsur.pdb" /debug /machine:I386 /out:"$(OUTDIR)\custsur.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\cfwrap.obj" \
	"$(INTDIR)\csur.obj" \
	"$(INTDIR)\custsur.obj" \
