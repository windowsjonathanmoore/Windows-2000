...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\cancel.pdb" /machine:I386 /out:"$(OUTDIR)\cancel.exe" 
LINK32_OBJS= \
	"$(INTDIR)\cancel.obj" \
	"$(INTDIR)\cancel.res" \
	"$(OUTDIR)\inproc.lib"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /entry:"WinMainCRTStartup" /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\cancel.pdb" /debug /machine:I386 /out:"$(OUTDIR)\cancel.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\cancel.obj" \
	"$(INTDIR)\cancel.res" \
	"$(OUTDIR)\inproc.lib"
