...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\inproc.pdb" /machine:I386 /def:".\dllsrv.def" /out:"$(OUTDIR)\inproc.dll" /implib:"$(OUTDIR)\inproc.lib" 
DEF_FILE= \
	".\dllsrv.def"
LINK32_OBJS= \
	"$(INTDIR)\SSERVER.OBJ"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:windows /dll /incremental:yes /pdb:"$(OUTDIR)\inproc.pdb" /debug /machine:I386 /def:".\dllsrv.def" /out:"$(OUTDIR)\inproc.dll" /implib:"$(OUTDIR)\inproc.lib" /pdbtype:sept 
DEF_FILE= \
	".\dllsrv.def"
LINK32_OBJS= \
	"$(INTDIR)\SSERVER.OBJ"
