...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\sta.pdb" /machine:I386 /out:"$(OUTDIR)\sta.exe" 
LINK32_OBJS= \
	"$(INTDIR)\SSERVER.OBJ"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\sta.pdb" /debug /machine:I386 /out:"$(OUTDIR)\sta.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\SSERVER.OBJ"
