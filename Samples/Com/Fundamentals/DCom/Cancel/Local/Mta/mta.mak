...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\mta.pdb" /machine:I386 /out:"$(OUTDIR)\mta.exe" 
LINK32_OBJS= \
	"$(INTDIR)\SSERVER.OBJ"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\mta.pdb" /debug /machine:I386 /out:"$(OUTDIR)\mta.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\SSERVER.OBJ"
