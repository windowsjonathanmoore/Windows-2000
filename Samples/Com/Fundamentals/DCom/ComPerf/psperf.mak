...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib rpcrt4.lib /nologo /dll /incremental:no /pdb:"$(OUTDIR)\psperf.pdb" /machine:I386 /def:".\psperf.def" /out:"$(OUTDIR)\psperf.dll" /implib:"$(OUTDIR)\psperf.lib" 
DEF_FILE= \
	".\psperf.def"
LINK32_OBJS= \
	"$(INTDIR)\psperf_p.obj" \
