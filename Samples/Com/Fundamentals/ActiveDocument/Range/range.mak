...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib urlmon.lib wininet.lib /nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\range.pdb" /machine:I386 /out:"$(OUTDIR)\range.exe" 
LINK32_OBJS= \
	"$(INTDIR)\cache.obj" \
	"$(INTDIR)\callback.obj" \
	"$(INTDIR)\download.obj" \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib urlmon.lib wininet.lib /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\range.pdb" /debug /machine:I386 /out:"$(OUTDIR)\range.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\cache.obj" \
	"$(INTDIR)\callback.obj" \
	"$(INTDIR)\download.obj" \
