...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\framer.pdb" /machine:I386 /out:"$(OUTDIR)\framer.exe" 
LINK32_OBJS= \
	"$(INTDIR)\framer.obj" \
	"$(INTDIR)\iadvsink.obj" \
	"$(INTDIR)\iclisite.obj" \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\Framer.pdb" /debug /machine:I386 /out:"$(OUTDIR)\Framer.exe" 
LINK32_OBJS= \
	"$(INTDIR)\framer.obj" \
	"$(INTDIR)\iadvsink.obj" \
	"$(INTDIR)\iclisite.obj" \
