...
LINK32=link.exe
LINK32_FLAGS=mtx.lib mtxguid.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib uuid.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\Vcacct.pdb" /machine:I386 /nodefaultlib:"msvcrt.lib" /def:".\Account.def" /out:"$(OUTDIR)\Vcacct.dll" /implib:"$(OUTDIR)\Vcacct.lib" 
DEF_FILE= \
	".\Account.def"
LINK32_OBJS= \
	"$(INTDIR)\Account.obj" \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib odbc32.lib uuid.lib /nologo /subsystem:windows /dll /incremental:yes /pdb:"$(OUTDIR)\vcacct.pdb" /debug /machine:I386 /nodefaultlib:"msvcrt.lib" /def:".\Account.def" /out:"$(OUTDIR)\vcacct.dll" /implib:"$(OUTDIR)\vcacct.lib" 
DEF_FILE= \
	".\Account.def"
LINK32_OBJS= \
	"$(INTDIR)\Account.obj" \
