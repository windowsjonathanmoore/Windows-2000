...
public:
	...
	virtual BOOL	RemoveObject(CBase* pCBase, BOOL fRemoveSubObjects, BOOL fObjectExists);
	virtual BOOL	RemoveNode(HTREEITEM hTreeItem, BOOL fRemoveSubObjects, BOOL fObjectExists);
	virtual BOOL	GarbageCollectNode(HTREEITEM hTreeItem, BOOL fRemoveSubObjects, BOOL fObjectExists);
