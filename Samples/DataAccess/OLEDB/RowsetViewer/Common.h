...
HRESULT FreeConstraintDesc(ULONG *pcConsDesc, DBCONSTRAINTDESC **prgConsDesc, BOOL fFree = TRUE);
...
BOOL		StringCompare(LPCWSTR pwsz1, LPCWSTR pwsz2, BOOL fCaseSensitive = TRUE);
