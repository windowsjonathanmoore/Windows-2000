...
public:
	...
	//constructors
	CVector(ULONG ulLowerBound = 0, ULONG ulGrowSize = 10);
	virtual ~CVector();
	...
	virtual TYPE*		InsertAt(ULONG iIndex, TYPE& element);	// Insert element at index
	virtual TYPE		RemoveAt(ULONG iIndex);					// Remove element at index
	
	//Attaching
	virtual void		Attach(CVector& rVector);
	virtual void		Attach(ULONG cElements, TYPE* rgElements);
	virtual void		Detach(ULONG* pcElements, TYPE** prgElements);

	//Array-like methods
	virtual TYPE&		operator[](ULONG iIndex);				//Index element

	//informational methods
	inline	const ULONG	GetCount()						{	return m_cElements;		}
	inline	const TYPE*	GetElements() const 			{	return m_rgElements;	}

protected:
	//data
	ULONG				m_ulMaxSize;							// MAX sizeof array
	ULONG				m_ulGrowSize;							// Size to Grow for each allocation
	ULONG				m_ulLowerBound;							// LowerBound of array
	ULONG				m_cElements;							// Number of elements
...
//
/////////////////////////////////////////////////////////////////////////////
template <class TYPE> CVector<TYPE>::CVector(ULONG ulLowerBound, ULONG ulGrowSize)
{
	//construct the array
...
//
///////////////////////////////////////////////////////////////
template <class TYPE> void CVector<TYPE>::Attach(CVector& rVector)
{
...
//
///////////////////////////////////////////////////////////////
template <class TYPE> void CVector<TYPE>::Attach(ULONG cElements, TYPE* rgElements)
{
	RemoveAll();
	CoTaskMemFree(m_rgElements);
...
//
///////////////////////////////////////////////////////////////
template <class TYPE> void CVector<TYPE>::Detach(ULONG* pcElements, TYPE** prgElements)
{
	ASSERT(pcElements);
	ASSERT(prgElements);
...
//
/////////////////////////////////////////////////////////////////////////////
template <class TYPE> TYPE CVector<TYPE>::RemoveAt(ULONG iIndex)
{
...
//
/////////////////////////////////////////////////////////////////////////////
template <class TYPE> TYPE* CVector<TYPE>::AddElement(TYPE& element)
{
...
//
/////////////////////////////////////////////////////////////////////////////
template <class TYPE> TYPE* CVector<TYPE>::InsertAt(ULONG iIndex, TYPE& element)
{
	iIndex -= m_ulLowerBound;
...
//
/////////////////////////////////////////////////////////////////////////////
template <class TYPE> TYPE& CVector<TYPE>::operator[](ULONG iIndex)
{
	iIndex -= m_ulLowerBound;
...
/////////////////////////////////////////////////////////////////////////////
template <class TYPE> class CVectorEx : public CVector<TYPE>
{
public:

	//constructors
	CVectorEx(ULONG ulLowerBound = 0, ULONG ulGrowSize = 10);
	virtual ~CVectorEx();

	//Helpers - require the operator== to be defined
	virtual void		RemoveElement(TYPE& element);
	virtual ULONG		FindElement(TYPE& element);				// Find index of element
...
//
/////////////////////////////////////////////////////////////////////////////
template <class TYPE> void CVectorEx<TYPE>::RemoveElement(TYPE& element)
{
	//Try to find the index of the element
	ULONG iIndex = FindElement(element);
...
//
/////////////////////////////////////////////////////////////////////////////
template <class TYPE> ULONG CVectorEx<TYPE>::FindElement(TYPE& element)
{
	//return pointer to found element
