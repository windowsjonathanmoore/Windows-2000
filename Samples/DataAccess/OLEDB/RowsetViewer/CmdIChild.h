...
public:
	...
	virtual HRESULT	ScrollGrid(LONG cItems);
...
public:
	...
	virtual HRESULT		DisplayData(REFIID riid, HROW hRow, INDEX iIndex);
	virtual HRESULT		DumpData(HROW hRow, INDEX iIndex, void* pData);
	...
	//ListView
	virtual HRESULT		GetListViewValues(HWND hWndNames, HWND hWndValues, CDataAccess* pCDataAccess, DBCOUNTITEM cBindings, DBBINDING* rgBindings, void* pData);
	...
	static INT_PTR WINAPI ParamExecuteProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam);
	...
	virtual HRESULT			GetChapteredChild(INDEX iSelectedCol, DBBINDING* pBinding, REFIID riid = IID_IRowset);
	...
	//Data
	INDEX					m_iSelectedRow;
	INDEX					m_iSelectedCol;
