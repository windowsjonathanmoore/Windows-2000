...
//Binding Errors
HRESULT		DisplayBindingErrors(HRESULT hrReturned, DBCOUNTITEM cBindings, DBBINDING* rgBindings, void* pData);
...
HRESULT		DisplayAccessorErrors(HRESULT hrReturned, DBCOUNTITEM cBindings, DBBINDING* rgBindings, DBBINDSTATUS* rgStatus);
