...
// File:		adoint.h
//
// Copyright:	Copyright (c) 1996 - 2000 Microsoft Corporation
//
...
EXTERN_C const IID IID__Recordset;
    ...
    public:
        ...
        virtual /* [hidden][id] */ HRESULT STDMETHODCALLTYPE Find( 
            /* [in] */ BSTR Criteria,
            /* [defaultvalue][in] */ VARIANT_BOOL SkipCurrent,
            /* [defaultvalue][in] */ SearchDirectionEnum SearchDirection,
            /* [defaultvalue][in] */ VARIANT Start) = 0;
...
#define _Recordset_Find(This,Criteria,SkipCurrent,SearchDirection,Start)	\
    (This)->lpVtbl -> Find(This,Criteria,SkipCurrent,SearchDirection,Start)
#endif /* COBJMACROS */
#endif 	/* C style interface */
