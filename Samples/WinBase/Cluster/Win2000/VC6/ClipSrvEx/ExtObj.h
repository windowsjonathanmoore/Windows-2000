...
#include "ExtObjID.h"	// for CLSID_CoClipSrvEx
#endif
...
DECLARE_REGISTRY( CExtObject, _T("CLUADMEX.ClipSrvEx"), _T("CLUADMEX.ClipSrvEx"), IDS_CLUADMEX_COMOBJ_DESC, THREADFLAGS_APARTMENT )
