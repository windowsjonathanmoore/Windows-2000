                     ...
                     LPSTR lpCmdLine, int nCmdShow)
{
    ...
    *****/
	...
	if (hLibrary == NULL)
	{
		// Try loading from the SPINCUBE sample directory if SPICUBE.DLL was not loaded
		// through the normal LoadLibrary search order
		hLibrary = LoadLibrary (TEXT("..\\..\\Controls\\custom\\SpinCube\\SpinCube.dll"));
	}
