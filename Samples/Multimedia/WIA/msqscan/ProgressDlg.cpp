...
UINT DataAcquireThreadProc(LPVOID pParam)
{
    HRESULT hr = S_OK;
...
{
    ::SendMessage(g_hWnd, WM_STEP_PROGRESS, 0, lPercentComplete);
    ::SendMessage(g_hWnd, WM_UPDATE_PROGRESS_TEXT, 0, (LPARAM)lpszText);
...
BOOL CProgressDlg::OnInitDialog()
{
    ...
    m_pDataAcquireThread = AfxBeginThread((AFX_THREADPROC)DataAcquireThreadProc, m_pDataAcquireInfo, THREAD_PRIORITY_NORMAL);
