...
DWORD_PTR   gdwCurCtrl = DID_STOP;
DWORD_PTR   gdwCurTool = DID_PEN;
...
LONG_PTR APIENTRY DrawSurfWndProc (HWND, UINT, WPARAM, LPARAM);
BOOL CALLBACK About           (HWND, UINT, WPARAM, LPARAM);
LONG_PTR APIENTRY TextWndProc     (HWND, UINT, WPARAM, LPARAM);
LONG_PTR APIENTRY CtrlPanelDlgProc(HWND, UINT, WPARAM, LPARAM);
