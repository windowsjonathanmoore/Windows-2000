...
LRESULT APIENTRY AboutDlgProc(HWND hWndDlg, UINT Message, WPARAM wParam, LPARAM
        lParam)
{
...
LRESULT APIENTRY PrintDlgProc(HWND hWndDlg, UINT Message, WPARAM wParam,
        LPARAM lParam)
{
        ...
        case WM_COMMAND:
            switch (wParam)
            {
                ...
                case IDC_SCALE:
                    ...
                    CheckRadioButton(hWndDlg, IDC_BESTFIT, IDC_SCALE, (int)wParam);
...
LRESULT APIENTRY SavingDlgProc(HWND hDlg, UINT message, WPARAM wParam,
        LPARAM lParam)
{
    switch (message)
    {
...
//
//***********************************************************************
LRESULT APIENTRY SelectDlgProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM
        lParam)
{
    switch (message)
    {
...
//
//***********************************************************************
LRESULT APIENTRY RectangleDlgProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM
        lParam)
{
    switch (message)
    {
