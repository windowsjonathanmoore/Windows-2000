...
int FAR PASCAL DlgEnumFontSizes (LPLOGFONT lpLogFont, LPTEXTMETRIC lpTextMetric, short nFontType, LPHANDLE lpData)
{
    HANDLE hFonts;
    LPFONTSTRUCT pFS;
    LPFONTLIST pFL;
...
int FAR PASCAL DlgEnumFontNames (LPLOGFONT lpLogFont, LPTEXTMETRIC lpTextMetric, short nFontType, LPHANDLE lpData)
{
    HDC  hdc;
    HWND hwnd;
    HANDLE hInst;
 ...
 */
BOOL APIENTRY CreateDlgProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    int wmId, i;
    BOOL bDone;
...
*/
BOOL APIENTRY MetricsDlgProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
static LOGFONT lfDlg;
static LPLOGFONT lplf;
...
/*
    ...
    the CreateFont call.
*/
BOOL APIENTRY EnumDlgProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
