...

{
    ...
    switch (id) {
        ...
        case IDM_OPEN:
                ...
                LoadString(hInst, IDS_OPENDIBPROMPT, lpBuffer, sizeof(lpBuffer));
                fh = DlgOpenFile (hWnd,
                                  lpBuffer,
        ...
        case IDM_SAVE:
                 ...
                 */
                LoadString(hInst, IDS_SAVEDIBPROMPT, lpBuffer, sizeof(lpBuffer));
                fh = DlgOpenFile (hWnd,
                                  lpBuffer,
                ...
                if (fh != 0){
                    ...
                    if (!hdibCurrent){
                        LoadString(hInst, IDS_CANTSAVEFILE, lpBuffer, sizeof(lpBuffer));
                        ErrMsg(lpBuffer);
                        return 0L;
                    }
