...
RRColor RRTexture::DoMapLookupLerp(INT32 iStage, INT32 iU, INT32 iV, INT16 iLOD)
{
    ...
    BOOL bColorKeyMatched00, bColorKeyMatched01, bColorKeyMatched10, bColorKeyMatched11;
    ...
    RRColor& Texel)
{
    ...
    FLOAT fUStepScaleLo, fVStepScaleLo;
...
ComputeEnvMapLevelOfDetail( const RRTextureCoord& TCoord, FLOAT& fLOD )
{
    ...
    // for large areas of triangles when environment mapping
    FLOAT fCoverage = (fLenX+fLenY)/2;
