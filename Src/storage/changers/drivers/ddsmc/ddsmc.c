...

{
    ...
    if (RtlCompareMemory(InquiryData->VendorId,"HP      ",8) == 8) {
        if (RtlCompareMemory(InquiryData->ProductId,"C1553A",6) == 6) {

            return TRUE;

        } else if (RtlCompareMemory(InquiryData->ProductId,"C1557A",6) == 6) {

            return TRUE;

        }
    } else if (RtlCompareMemory(InquiryData->VendorId,"DEC     ",8) == 8) {
        if (RtlCompareMemory(InquiryData->ProductId,"TLZ9",4) == 4) {

            return TRUE;
        } else if (RtlCompareMemory(InquiryData->ProductId,"TLZ1",4) == 4) {

            return TRUE;
        }
    } else if (RtlCompareMemory(InquiryData->VendorId,"SONY",4) == 4) {
        if (RtlCompareMemory(InquiryData->ProductId,"TSL-7000",8) == 8) {

            return TRUE;

        } else if (RtlCompareMemory(InquiryData->ProductId,"TSL-9000",8) == 8) {

            return TRUE;

        }
    } else if (RtlCompareMemory(InquiryData->VendorId,"ADIC    ",8) == 8) {
        if (RtlCompareMemory(InquiryData->ProductId,"800E",4)== 4) {
