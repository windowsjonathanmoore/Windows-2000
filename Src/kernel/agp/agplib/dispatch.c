...

{
    ...
    switch (irpStack->MinorFunction) {
        case IRP_MN_QUERY_INTERFACE:
            ...
            //
            if ((RtlEqualMemory(irpStack->Parameters.QueryInterface.InterfaceType,
                                &GUID_AGP_BUS_INTERFACE_STANDARD,
                                sizeof(GUID)))                                  &&
                (irpStack->Parameters.QueryInterface.Size >= sizeof(AGP_BUS_INTERFACE_STANDARD)) &&
                (irpStack->Parameters.QueryInterface.Version == AGP_INTERFACE_VERSION)) {
                ...
                Interface->Version = AGP_INTERFACE_VERSION;
