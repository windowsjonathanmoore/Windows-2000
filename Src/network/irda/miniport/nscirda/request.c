...
//  These OIDs do not appear in ntddndis.h; they are in the OID space
//  reserved for vendor-specific IRDA stuff.
//  These definitions must agree with the ones in FASTIR.
//
//#define OID_IRDA_RELEASE_HW_RESOURCES   (OID_IRDA_RESERVED1+0)
//#define OID_IRDA_REACQUIRE_HW_RESOURCES (OID_IRDA_RESERVED1+1)
    ...
    OUT PULONG BytesNeeded)
{
    ...
    static  NDIS_OID NSCGlobalSupportedOids[] = {
