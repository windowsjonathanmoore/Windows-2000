...
EXTERN_C const IID IID_IWiaDevMgr;
    ...
    typedef struct IWiaDevMgrVtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *RegisterEventCallbackProgram )( 
            IWiaDevMgr __RPC_FAR * This,
            /* [in] */ LONG lFlags,
            /* [in] */ BSTR bstrDeviceID,
            /* [in] */ const GUID __RPC_FAR *pEventGUID,
...
typedef struct _WIA_EXTENDED_TRANSFER_INFO __RPC_FAR *PWIA_EXTENDED_TRANSFER_INFO;
...
EXTERN_C const IID IID_IWiaDataTransfer;
    ...
    typedef struct IWiaDataTransferVtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *idtGetExtendedTransferInfo )( 
            IWiaDataTransfer __RPC_FAR * This,
...
EXTERN_C const IID IID_IWiaPropertyStorage;
    ...
    typedef struct IWiaPropertyStorageVtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *SetPropertyStream )( 
            IWiaPropertyStorage __RPC_FAR * This,
            /* [in] */ GUID __RPC_FAR *pCompatibilityId,
            /* [unique][in] */ IStream __RPC_FAR *pIStream);
...
EXTERN_C const IID IID_IEnumWiaItem;
    ...
    public:
        virtual /* [local] */ HRESULT STDMETHODCALLTYPE Next( 
            /* [in] */ ULONG celt,
            /* [length_is][size_is][out] */ IWiaItem __RPC_FAR *__RPC_FAR *ppIWiaItem,
            /* [unique][out][in] */ ULONG __RPC_FAR *pceltFetched) = 0;
...
EXTERN_C const IID IID_IWiaLog;
    ...
    typedef struct IWiaLogVtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *InitializeLog )( 
            IWiaLog __RPC_FAR * This,
            /* [in] */ LONG hInstance);
        
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *hResult )( 
            IWiaLog __RPC_FAR * This,
            /* [in] */ HRESULT hResult);
    ...
    interface IWiaLog
    {
        CONST_VTBL struct IWiaLogVtbl __RPC_FAR *lpVtbl;
    };
...
EXTERN_C const IID IID_IWiaLogEx;
    ...
    typedef struct IWiaLogExVtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *InitializeLogEx )( 
            IWiaLogEx __RPC_FAR * This,
            /* [in] */ LONG hInstance);
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *hResultEx )( 
            IWiaLogEx __RPC_FAR * This,
            /* [in] */ LONG lMethodId,
            /* [in] */ HRESULT hResult);
        
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *LogEx )( 
            IWiaLogEx __RPC_FAR * This,
            /* [in] */ LONG lMethodId,
            /* [in] */ LONG lFlags,
            /* [in] */ LONG lResID,
    ...
    interface IWiaLogEx
    {
        CONST_VTBL struct IWiaLogExVtbl __RPC_FAR *lpVtbl;
    };
