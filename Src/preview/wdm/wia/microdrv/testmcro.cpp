...
// #define _DEBUG_COMMANDS
    ...
    case CMD_GETCAPABILITIES:
        ...
        pValue->lVal = GetButtonCount();
        pValue->pGuid = g_Buttons;
        pValue->lButtonNames = (LONG)g_ButtonNames;
        hr = S_OK;
#endif
        break;
    default:
            ...
            switch ( dwIndex ) {
                case WAIT_OBJECT_0+1:
                    ...
                    if ( dwBytesRet ) {
                        ...
                        if (*(HANDLE*)pValue->lVal != INVALID_HANDLE_VALUE) {
                            ...
                            Trace(TEXT("Setting This Event by Handle %d"),*(HANDLE*)pValue->lVal);

                            //
                            // signal the event, after a button GUID was assigned.
                            //

                            SetEvent(*(HANDLE*)pValue->lVal);
                        }
                        break;
                    }
