...
//
// Definitions for TYMED/FORMAT pairs specified in drvGetWiaFormatInfo
//
...
//
// Definitions for capabilities specified in drvGetCapabilities
//
...
#define INITIAL_FORMAT             (GUID*) &IMGFMT_MEMORYBMP
...
GUID* g_pInitialFormatArray [NUM_INITIALFORMATS] = {(GUID*) &IMGFMT_MEMORYBMP };
