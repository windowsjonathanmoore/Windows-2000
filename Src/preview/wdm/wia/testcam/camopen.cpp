    ...
    LONG                   *plDevErrVal)
{
    ...
    wiasWritePropGuid(pWiasContext, WIA_IPA_PREFERRED_FORMAT, IMGFMT_BMP);
...
SetFormatAttribs()
{
    ...
    gItemPropInfos[FORMAT_INDEX].ValidVal.ListGuid.Nom      = IMGFMT_BMP;

    //
    // Set up the format clsid list
    //

    gGuidFormats[0] = IMGFMT_BMP;
    gGuidFormats[1] = IMGFMT_MEMORYBMP;
