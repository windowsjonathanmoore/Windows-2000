...
// Return Value:
//    None.
void dbgError (LPSTR szMsg)
{
    static TCHAR szErrorMessage[1024];
    ...
    // This is for the guys who don't have a debugger.
...
void AC97ShowSet (PSP_DEVICE_INTERFACE_DETAIL_DATA pDeviceInterfaceDetailData)
{
    ...
    {
        dbgError ("AC97ShowSet: CreateFile: ");
        return;
    }
    ...
    if (!fSuccess)
    {
        dbgError ("AC97ShowSet: DeviceIoControl: ");
    }
                      ...
                      tAC97Features *pAC97Features)
{
    ...
    if (hTopology == INVALID_HANDLE_VALUE)
    {
        dbgError ("GetAC97Features: CreateFile: ");
        return FALSE;
    }
    ...
    if (!fSuccess)
    {
        dbgError ("GetAC97Features: DeviceIoControl: ");
        return FALSE;
    }
                               ...
                               PSP_DEVICE_INTERFACE_DETAIL_DATA *ppDeviceInterfaceDetailData)
{
	...
	{
		dbgError ("GetDeviceInterfaceDetail: SetupDiGetDeviceInstanceId: ");
        return FALSE;
	}
    ...
    {
		dbgError ("GetDeviceInterfaceDetail: LocalAlloc: ");
        return FALSE;
    }
    ...
    {
		dbgError ("GetDeviceInterfaceDetail: SetupDiGetClassDevs: ");
        return FALSE;
    }
    ...
    if (!fSuccess)
	{
		dbgError ("GetDeviceInterfaceDetail: SetupDiEnumDeviceInterfaces: ");
	...
	{
		dbgError ("GetDeviceInterfaceDetail: SetupDiGetDeviceInterfaceDetail: ");
        SetupDiDestroyDeviceInfoList (hDevInfoWithInterface);
        return FALSE;
	}
    ...
    // The size contails only the structure, not the additional path.
...
)
{
    ...
    if (!pAC97Features)
    {
        dbgError ("AC97PropPageProvider: LocalAlloc: ");
        return FALSE;
    }
	...
	PropSheetPage.dwFlags		= PSP_HASHELP;
