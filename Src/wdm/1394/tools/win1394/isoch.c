    ...
    )
{
    ...
    switch (uMsg) {
        ...
        case WM_INITDIALOG:
            ...
            _ultoa(HandleToUlong(pIsochAttachBuffers->hResource), tmpBuff, 16);
        ...
        case WM_COMMAND:
            ...
            switch (LOWORD(wParam)) {
                ...
                case IDOK:
                    ...
                    pIsochAttachBuffers->hResource = (HANDLE)strtoul(tmpBuff, NULL, 16);
    ...
    )
{
    ...
    switch (uMsg) {
        ...
        case WM_INITDIALOG:
            ...
            _ultoa(HandleToUlong(pIsochDetachBuffers->hResource), tmpBuff, 16);
            ...
            _ultoa((ULONG)pIsochDetachBuffers->pIsochDescriptor, tmpBuff, 16);
        ...
        case WM_COMMAND:
            ...
            switch (LOWORD(wParam)) {
                ...
                case IDOK:
                    ...
                    pIsochDetachBuffers->hResource = (HANDLE)strtoul(tmpBuff, NULL, 16);
                    ...
                    pIsochDetachBuffers->pIsochDescriptor = strtoul(tmpBuff, NULL, 16);
    ...
    )
{
    ...
    switch (uMsg) {
        ...
        case WM_INITDIALOG:
            ...
            _ultoa(HandleToUlong(*pHandle), tmpBuff, 16);
        ...
        case WM_COMMAND:
            ...
            switch (LOWORD(wParam)) {
                ...
                case IDOK:
                    ...
                    *pHandle = (HANDLE)strtoul(tmpBuff, NULL, 16);
    ...
    )
{
    ...
    switch (uMsg) {
        ...
        case WM_INITDIALOG:
            ...
            _ultoa(HandleToUlong(pIsochListen->hResource), tmpBuff, 16);
        ...
        case WM_COMMAND:
            ...
            switch (LOWORD(wParam)) {
                ...
                case IDOK:
                    ...
                    pIsochListen->hResource = (HANDLE)strtoul(tmpBuff, NULL, 16);
    ...
    )
{
    ...
    switch (uMsg) {
        ...
        case WM_INITDIALOG:
            ...
            _ultoa(HandleToUlong(pIsochSetChannelBandwidth->hBandwidth), tmpBuff, 16);
        ...
        case WM_COMMAND:
            ...
            switch (LOWORD(wParam)) {
                ...
                case IDOK:
                    ...
                    pIsochSetChannelBandwidth->hBandwidth = (HANDLE)strtoul(tmpBuff, NULL, 16);
    ...
    )
{
    ...
    switch (uMsg) {
        ...
        case WM_INITDIALOG:
            ...
            // put offset low and high and buffer length in edit controls
            _ultoa(HandleToUlong(pIsochStop->hResource), tmpBuff, 16);
        ...
        case WM_COMMAND:
            ...
            switch (LOWORD(wParam)) {
                ...
                case IDOK:
                    ...
                    pIsochStop->hResource = (HANDLE)strtoul(tmpBuff, NULL, 16);
    ...
    )
{
    ...
    switch (uMsg) {
        ...
        case WM_INITDIALOG:
            ...
            // put offset low and high and buffer length in edit controls
            _ultoa(HandleToUlong(pIsochTalk->hResource), tmpBuff, 16);
        ...
        case WM_COMMAND:
            ...
            switch (LOWORD(wParam)) {
                ...
                case IDOK:
                    ...
                    pIsochTalk->hResource = (HANDLE)strtoul(tmpBuff, NULL, 16);
