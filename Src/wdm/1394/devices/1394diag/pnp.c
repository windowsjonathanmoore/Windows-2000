    ...
    )
{
    ...
    switch (IrpSp->MinorFunction) {
        ...
        case IRP_MN_START_DEVICE:
            ...
            ntStatus = t1394Diag_SubmitIrpSynch(deviceExtension->StackDeviceObject, Irp, NULL);
    ...
    )
{
    ...
    ntStatus = t1394Diag_GetGenerationCount(DeviceObject, Irp, &deviceExtension->GenerationCount);
            ...
            if (IsochResourceData) {
                ...
                if (ResourceIrp == NULL) {
                    ...
                    if (!pIrb) {
                        ...
                        ntStatus = t1394Diag_SubmitIrpSynch(deviceExtension->StackDeviceObject, ResourceIrp, pIrb);
