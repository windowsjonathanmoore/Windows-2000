rem This will dump all classes, run tests and then dump all classes
rem
...
Classy = BaseName & "_DiagTest"
DumpAndList(Classy)

Classy = BaseName & "_DiagResult"
DumpAndList(Classy)

Classy = BaseName & "_DiagSetting"
DumpAndList(Classy)

Classy = BaseName & "_DiagTestForMSE"
DumpAndList(Classy)
...
Classy = BaseName & "_DiagTestSoftware"
DumpAndList(Classy)

Classy = BaseName & "_DiagSettingForTest"
DumpAndList(Classy)

Classy = BaseName & "_DiagTestInPkg"
DumpAndList(Classy)

Classy = BaseName & "_DiagResultInPkg"
DumpAndList(Classy)
