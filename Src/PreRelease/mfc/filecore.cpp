...
CFile::~CFile()
{
	if (m_hFile != (UINT_PTR)hFileNull && m_bCloseOnDelete)
		Close();
}
...
{
	ASSERT_VALID(this);
	ASSERT(m_hFile != (UINT_PTR)hFileNull);
