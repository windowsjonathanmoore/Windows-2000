...
static void ConstructElements(CString* pNewData, INT_PTR nCount)
{
	ASSERT(nCount >= 0);
...
static void DestructElements(CString* pOldData, INT_PTR nCount)
{
	ASSERT(nCount >= 0);
...
static void CopyElements(CString* pDest, CString* pSrc, INT_PTR nCount)
{
	ASSERT(nCount >= 0);
