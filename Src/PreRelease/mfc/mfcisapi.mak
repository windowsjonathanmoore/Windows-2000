...
!if "$(PLATFORM)" == "IA64" || "$(PLATFORM)" == "ALPHA64"
WIN64=1
!endif
...
!if "$(WIN64)" == "1"
TARGDEFS=$(TARGDEFS) /D_AFX_NO_DAO_SUPPORT
!endif
...
!if "$(PLATFORM)" == "ALPHA64"
CL_OPT=/Ap64 /W4 /WX /Zl /GX $(DEBOPTS) $(CVOPTS) $(TARGOPTS)
!if "$(NOWP64)" != "1"
CL_OPT=$(CL_OPT) /Wp64
!endif
!endif
...
!if "$(PLATFORM)" == "IA64"
!if "$(DEBUG)" != "0"
INETASM=ia64\inetcald.obj
!else
INETASM=ia64\inetcaln.obj
!endif
!endif
