        ...
        )
{
        ...
        switch(specifier) {             /* switch on specifier */
                ...
                case('c'):              /* date and time display */
                        ...
                        {
#ifdef _MT
                                _store_winword(ptloci, lc_time->ww_ldatefmt,
#else  /* _MT */
                                _store_winword(lc_time->ww_ldatefmt,
#endif  /* _MT */
                                               timeptr, string, left, lc_time,
                                               FALSE);
                                if (*left == 0)
                                        return;
                                *(*string)++=' ';
                                (*left)--;
#ifdef _MT
                                _store_winword(ptloci, lc_time->ww_timefmt,
#else  /* _MT */
                                _store_winword(lc_time->ww_timefmt,
#endif  /* _MT */
                                               timeptr, string, left, lc_time,
                                               FALSE);
                        }
...
#ifdef _MT
                                _store_winword(ptloci, lc_time->ww_sdatefmt,
#else  /* _MT */
                                _store_winword(lc_time->ww_sdatefmt,
#endif  /* _MT */
                                               timeptr, string, left, lc_time,
                                               FALSE);
                                if (*left == 0)
                ...
                case('X'):              /* time display */
#ifdef _MT
                        _store_winword(ptloci, lc_time->ww_timefmt, timeptr,
#else  /* _MT */
                        _store_winword(lc_time->ww_timefmt, timeptr,
#endif  /* _MT */
                                       string, left, lc_time, FALSE);
                        break;
        ...
        )
{
        ...
        while (*format && *count != 0)
        {
                ...
                {
#ifdef _MT
                        _expandtime(ptloci, specifier, tmptr, out, count,
#else  /* _MT */
                        _expandtime(specifier, tmptr, out, count,
#endif  /* _MT */
                                    lc_time, alternate_form);
