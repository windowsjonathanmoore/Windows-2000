...
LOCAL(void) write_char(_TINT ch, int *pnumwritten);
LOCAL(void) write_multi_char(_TINT ch, int num, int *pnumwritten);
...
LOCAL(void) write_char(_TINT ch, FILE *f, int *pnumwritten);
LOCAL(void) write_multi_char(_TINT ch, int num, FILE *f, int *pnumwritten);
