        ...
        )
{
         ...
         */
        __crtInitCritSecAndSpinCount( _locktable[_LOCKTAB_LOCK], _CRT_SPINCOUNT );
        __crtInitCritSecAndSpinCount( _locktable[_EXIT_LOCK1], _CRT_SPINCOUNT );
        __crtInitCritSecAndSpinCount( _locktable[_HEAP_LOCK], _CRT_SPINCOUNT );
        __crtInitCritSecAndSpinCount( _locktable[_SIGNAL_LOCK], _CRT_SPINCOUNT );
}
        ...
        )
{
        ...
        if ( _locktable[locknum] == NULL ) {
            ...
            if ( _locktable[locknum] == NULL ) {
                __crtInitCritSecAndSpinCount(pcs, _CRT_SPINCOUNT);
